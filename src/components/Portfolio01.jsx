      ...
      <Grid container spacing={2} justifyContent="center" marginY="40px">
        ...
        <Grid item xs={12} sm={6} md={6}>
          ...
          >
            ...
            >
              I started with minor project tweaks and grew into creating my own
              software projects. These personal endeavors have shaped me as a
              developer, honing my skills and fueling my passion for coding.
            </Typography>
          </Box>
        </Grid>
